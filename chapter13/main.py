...
import numpy as np
from schemas import FantasAcquisitionFeatures, PredictionOutput
...
#Load the ONNX model
sess_10 = rt.InferenceSession("acquisition_model_10.onx",
                              providers=["CPUExecutionProvider"])
sess_50 = rt.InferenceSession("acquisition_model_50.onx",
                              providers=["CPUExecutionProvider"])
sess_90 = rt.InferenceSession("acquisition_model_90.onx",
                              providers=["CPUExecutionProvider"])
...
def root():
    return {"message": "API health check succesful"}
...
def predict(features: FantasAcquisitionFeatures):
